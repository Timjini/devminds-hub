...
export default async function Page({ params }: PageProps<'/[lang]'>) {
  ...
  return (
    <main>
      <Hero
              section={
              <VideoComponent videoId="boxingVideo" videoUrl="https://pub-b6b56492600944d2a120f4f26623677a.r2.dev/public/boxing1.mp4"
              ...
              />
               ...
               title={
                <>
                   <div className={`absolute bottom-6 ${lang === 'ar-Ar'? "right-12" : "left-12"} z-20 text-white`}>
                    <DecoText
